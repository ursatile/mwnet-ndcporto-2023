...
namespace Rockaway.WebApp.Migrations
{
    ...
    [Migration("20231017154034_TicketTypesAndVenueCultures")]
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "3c260f39-4c9e-42e9-bd0f-b0b38015fb18",
                            Email = "admin@rockaway.dev",
                            EmailConfirmed = true,
                            LockoutEnabled = true,
                            NormalizedEmail = "ADMIN@ROCKAWAY.DEV",
                            NormalizedUserName = "ADMIN@ROCKAWAY.DEV",
                            PasswordHash = "AQAAAAIAAYagAAAAEA8Buka69G/vWCW/MRRoG3fqnLIObPSajFvmK1kj/woZzA5/pvWAbdJCtwqLHMsiVw==",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "58549eb6-2ef6-4c10-90fb-dc31ef0af2e0",
            ...
            modelBuilder.Entity("Rockaway.WebApp.Data.Entities.TicketType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c878ce66-7d7e-4e23-b153-bc885ae42ede"),
                            Name = "General Admission",
                            Price = 25m,
                            ShowDate = new DateTime(2023, 10, 17, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ShowVenueId = new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbb7")
                        },
                        new
                        {
                            Id = new Guid("4886d0a8-f8a8-473a-a5e7-feb24e7f91a9"),
                            Name = "General Admission",
                            Price = 35m,
                            ShowDate = new DateTime(2023, 10, 18, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ShowVenueId = new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbb3")
                        },
                        new
                        {
                            Id = new Guid("5c39b8cd-e620-48d9-bbdd-056bf95cdca4"),
                            Name = "VIP Meet & Greet",
                            Price = 75m,
                            ShowDate = new DateTime(2023, 10, 18, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ShowVenueId = new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbb3")
                        ...
                        new
                        {
                            Id = new Guid("70a797d5-4fb5-4f3f-9154-6e51b9e7d239"),
                            Name = "General Admission",
                            Price = 35m,
                            ShowDate = new DateTime(2023, 10, 19, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ShowVenueId = new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbb2")
                        },
                        new
                        {
                            Id = new Guid("702e5852-e4c1-4150-87b8-3f752e7276d2"),
                            Name = "VIP Meet & Greet",
                            Price = 75m,
                            ShowDate = new DateTime(2023, 10, 19, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ShowVenueId = new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbb2")
                        ...
                        new
                        {
                            Id = new Guid("6e139d3a-1299-4e0e-9ad6-b9c2dfaaa792"),
                            Name = "General Admission",
                            Price = 25m,
                            ShowDate = new DateTime(2023, 10, 20, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ShowVenueId = new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbb9")
                        },
                        new
                        {
                            Id = new Guid("541fb9a6-678c-4cef-9244-d76de44910bc"),
                            Name = "VIP Meet & Greet",
                            Price = 55m,
                            ShowDate = new DateTime(2023, 10, 20, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ShowVenueId = new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbb9")
                        ...
                        new
                        {
                            Id = new Guid("afb8b2cf-bc0f-4e60-a67e-b2d40c1b3550"),
                            Name = "General Admission",
                            Price = 350m,
                            ShowDate = new DateTime(2023, 10, 22, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ShowVenueId = new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbb5")
                        },
                        new
                        {
                            Id = new Guid("a5bc0691-656c-43f0-9e78-085edc98100c"),
                            Name = "VIP Meet & Greet",
                            Price = 750m,
                            ShowDate = new DateTime(2023, 10, 22, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ShowVenueId = new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbb5")
                        ...
                        new
                        {
                            Id = new Guid("6e087259-395d-4721-834e-5aa5d472eef9"),
                            Name = "General Admission",
                            Price = 300m,
                            ShowDate = new DateTime(2023, 10, 23, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ShowVenueId = new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbb8")
                        },
                        new
                        {
                            Id = new Guid("97c06545-73fc-4fcd-8b2c-d1e71c5fe704"),
                            Name = "VIP Meet & Greet",
                            Price = 720m,
                            ShowDate = new DateTime(2023, 10, 23, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ShowVenueId = new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbb8")
                        ...
                        new
                        {
                            Id = new Guid("f540f8bd-ea3b-49ce-b753-e4158c17986f"),
                            Name = "General Admission",
                            Price = 25m,
                            ShowDate = new DateTime(2023, 10, 25, 0, 0, 0, 0, DateTimeKind.Unspecified),
